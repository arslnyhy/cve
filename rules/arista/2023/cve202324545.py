...
def rule_cve202324545(configuration, commands, device, devices):
    """
    This rule checks for CVE-2023-24545 vulnerability in Arista CloudEOS devices.
    ...
    assert not is_vulnerable, (
        ...
        "For more information, see https://www.arista.com/en/support/advisories-notices/security-advisory/17240-security-advisory-0085"
    )
