...
def rule_cve202320262(configuration, commands, device, devices):
    ...
    which could allow an unauthenticated, remote attacker to cause a process crash, resulting in a DoS condition for SSH access.
    """
    ...
    assert not ssh_configured, (
        ...
        "For more information, see https://sec.cloudapps.cisco.com/security/center/content/CiscoSecurityAdvisory/cisco-sa-sdwan-vman-sc-LRLfu2z"
    )
