...
def rule_cve202320185(configuration, commands, device, devices):
    ...
    The vulnerability is due to an issue with the implementation of the ciphers used by the CloudSec encryption feature,
    which could allow an unauthenticated, remote attacker to read or modify intersite encrypted traffic.
    """
    ...
    assert not cloudsec_configured, (
        ...
        "For more information, see https://sec.cloudapps.cisco.com/security/center/content/CiscoSecurityAdvisory/cisco-sa-aci-cloudsec-enc-Vs5Wn2sX"
    )
