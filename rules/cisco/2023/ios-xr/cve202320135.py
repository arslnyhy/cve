...
def rule_cve202320135(configuration, commands, device, devices):
    ...
    An attacker could exploit this vulnerability by modifying an ISO image and then carrying out install requests in parallel.
    ...
    assert not install_issue_detected, (
        ...
        "For more information, see https://sec.cloudapps.cisco.com/security/center/content/CiscoSecurityAdvisory/cisco-sa-lnt-L9zOkBz5"
    )
