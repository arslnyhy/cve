...
def rule_cve202320273(configuration, commands, device, devices):
    """
    This rule checks for the CVE-2023-20273 vulnerability in Cisco IOS XE Software.
    The vulnerability is due to insufficient input validation in the web UI feature.
    An authenticated, remote attacker could exploit this vulnerability by sending crafted
    input to the web UI, allowing them to inject commands to the underlying operating system
    ...
    assert not webui_enabled, (
        f"Device {device.name} is vulnerable to CVE-2023-20273. "
        ...
        "For more information, see https://sec.cloudapps.cisco.com/security/center/content/CiscoSecurityAdvisory/cisco-sa-iosxe-webui-privesc-j22SaA4z"
    )
