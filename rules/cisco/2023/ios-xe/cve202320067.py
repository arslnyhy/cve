...
def rule_cve202320067(configuration, commands, device, devices):
    ...
    The vulnerability is due to insufficient input validation of received traffic in the HTTP-based client profiling feature.
    ...
    assert not wlc_configured, (
        ...
        "For more information, see https://sec.cloudapps.cisco.com/security/center/content/CiscoSecurityAdvisory/cisco-sa-ewlc-dos-wFujBHKw"
    )
