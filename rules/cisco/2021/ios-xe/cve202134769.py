...
def rule_cve202134769(configuration, commands, device, devices):
    """
    This rule checks for CVE-2021-34769 vulnerability in Cisco IOS XE Software for Catalyst 9000 
    ...
    insufficient validation of CAPWAP packets.
    """
    ...
    assert not is_vulnerable, (
        f"Device {device.name} is potentially vulnerable to CVE-2021-34769. "
        ...
        "CAPWAP packets. "
        "For more information, see https://tools.cisco.com/security/center/content/CiscoSecurityAdvisory/cisco-sa-ewlc-capwap-dos-gmNjdKOY"
    )
