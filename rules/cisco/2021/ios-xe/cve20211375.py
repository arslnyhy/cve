...
def rule_cve20211375(configuration, commands, device, devices):
    """
    This rule checks for CVE-2021-1375 vulnerability in Cisco IOS XE Software.
    ...
    unsigned binaries on affected Catalyst 3850 and 9300 Series Switches.
    """
    ...
    # Check if this is a vulnerable platform (Catalyst 3850 or 9300 Series)
    ...
    assert not fast_reload_enabled, (
        f"Device {device.name} is potentially vulnerable to CVE-2021-1375. "
        ...
        "For more information, see https://tools.cisco.com/security/center/content/CiscoSecurityAdvisory/cisco-sa-fast-Zqr6DD5"
    )
