...
def rule_cve20211612(configuration, commands, device, devices):
    """
    This rule checks for CVE-2021-1612 vulnerability in Cisco IOS XE SD-WAN Software.
    The vulnerability in the CLI could allow an authenticated, local attacker to overwrite 
    arbitrary files on the local system due to improper access controls on files within 
    ...
    # Check for SD-WAN configuration and user accounts
    ...
    assert not is_vulnerable, (
        f"Device {device.name} is potentially vulnerable to CVE-2021-1612. "
        ...
        "For more information, see https://tools.cisco.com/security/center/content/CiscoSecurityAdvisory/cisco-sa-sd-wan-GjR5pGOm"
    )
