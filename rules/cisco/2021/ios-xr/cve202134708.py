...
def rule_cve202134708(configuration, commands, device, devices):
    """
    This rule checks for the CVE-2021-34708 vulnerability in Cisco IOS XR Software.
    ...
    assert not is_vulnerable, (
        f"Device {device.name} is vulnerable to CVE-2021-34708. "
