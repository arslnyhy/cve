...
def rule_cve20211244(configuration, commands, device, devices):
    """
    This rule checks for the CVE-2021-1244 vulnerability in Cisco IOS XR Software.
    ...
    assert not is_vulnerable, (
        f"Device {device.name} is vulnerable to CVE-2021-1244. "
        ...
        "For more information, see https://tools.cisco.com/security/center/content/CiscoSecurityAdvisory/cisco-sa-ioxr-l-zNhcGCBt"
    )
