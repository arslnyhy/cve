...
def rule_cve202420399(configuration, commands, device, devices):
    ...
    vulnerable_versions = [
        ...
        '9.3(12)', '9.3(13)', '9.4(1)', '9.4(1a)', '9.4(2)',

        # 10.x versions
        '10.1(1)', '10.1(2)', '10.2(1)', '10.2(1q)', '10.2(2)', '10.2(2a)', '10.2(3)',
        '10.2(4)', '10.2(5)', '10.2(6)', '10.2(7)', '10.2(8)', '10.3(1)', '10.3(2)',
        '10.3(3)', '10.3(3o)', '10.3(3p)', '10.3(3q)', '10.3(3r)', '10.3(3w)', '10.3(3x)',
        '10.3(4)', '10.3(4a)', '10.3(4g)', '10.3(5)', '10.3(99w)', '10.3(99x)', '10.4(1)',
        '10.4(2)'
    ]
    ...
    # Check if the device is running on a vulnerable platform
    for platform in vulnerable_platforms:
        if platform in show_version_output:
            assert False, (
                f"Device {device.name} is vulnerable to CVE-2024-20399. "
                f"The device is running a vulnerable version AND platform: {platform}. "
                "For more information, see https://www.sygnia.co/threat-reports-and-advisories/china-nexus-threat-group-velvet-ant-exploits-cisco-0-day/"
            )
