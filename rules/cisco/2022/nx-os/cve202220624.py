...
def rule_cve202220624(configuration, commands, device, devices):
    ...
    assert not cfs_enabled, (
        ...
        "which could allow an unauthenticated attacker to cause a denial of service through crafted CFSoIP packets. "
        "For more information, see https://tools.cisco.com/security/center/content/CiscoSecurityAdvisory/cisco-sa-cfsoip-dos-tpykyDr"
    )
