...
def rule_cve202220623(configuration, commands, device, devices):
    ...
    assert not bfd_enabled, (
        ...
        "which could allow an unauthenticated attacker to cause BFD session flaps and a denial of service through crafted traffic. "
        "For more information, see https://tools.cisco.com/security/center/content/CiscoSecurityAdvisory/cisco-sa-nxos-bfd-dos-wGQXrzxn"
    )
