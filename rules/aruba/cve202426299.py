...
def rule_cve202426299(configuration, commands, device, devices):
    """
    This rule checks for CVE-2024-26299 vulnerability in Aruba ClearPass Policy Manager.
    The vulnerability allows authenticated users to conduct stored cross-site scripting (XSS) attacks
    against administrative users through the web-based management interface.
    """
    ...
    assert not web_enabled, (
        f"Device {device.name} is vulnerable to CVE-2024-26299. "
