...
def rule_cve202431467(configuration, commands, device, devices):
    """
    This rule checks for CVE-2024-31467 vulnerability in Aruba InstantOS and ArubaOS devices.
    ...
    assert not papi_enabled, (
        f"Device {device.name} is vulnerable to CVE-2024-31467. "
