...
def rule_cve202426304(configuration, commands, device, devices):
    """
    This rule checks for CVE-2024-26304 vulnerability in Aruba devices.
    The vulnerability allows unauthenticated remote code execution through a buffer overflow
    in the L2/L3 Management service by sending specially crafted packets to the PAPI UDP port (8211).
    """
    ...
    assert not papi_enabled, (
        f"Device {device.name} is vulnerable to CVE-2024-26304. "
