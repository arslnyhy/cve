...
def rule_cve202442396(configuration, commands, device, devices):
    """
    This rule checks for CVE-2024-42396 vulnerability in Aruba InstantOS and Access Points.
    ...
    assert not cert_mgmt_enabled, (
        f"Device {device.name} is vulnerable to CVE-2024-42396. "
