...
def rule_cve202442507(configuration, commands, device, devices):
    """
    This rule checks for CVE-2024-42507 vulnerability in ArubaOS devices.
    ...
    assert not papi_enabled, (
        f"Device {device.name} is vulnerable to CVE-2024-42507. "
