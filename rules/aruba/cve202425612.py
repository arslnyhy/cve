...
def rule_cve202425612(configuration, commands, device, devices):
    """
    This rule checks for CVE-2024-25612 vulnerability in ArubaOS Wi-Fi Controllers and Campus/Remote Access Points.
    ...
    assert not cli_enabled, (
        f"Device {device.name} is vulnerable to CVE-2024-25612. "
