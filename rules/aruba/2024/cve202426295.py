...
def rule_cve202426295(configuration, commands, device, devices):
    """
    This rule checks for CVE-2024-26295 vulnerability in Aruba ClearPass Policy Manager.
    ...
    assert not web_enabled, (
        f"Device {device.name} is vulnerable to CVE-2024-26295. "
