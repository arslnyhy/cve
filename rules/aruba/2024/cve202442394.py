...
def rule_cve202442394(configuration, commands, device, devices):
    """
    This rule checks for CVE-2024-42394 vulnerability in Aruba InstantOS and Access Points.
    ...
    assert not soft_ap_enabled, (
        f"Device {device.name} is vulnerable to CVE-2024-42394. "
