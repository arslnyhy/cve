...
def rule_cve202431472(configuration, commands, device, devices):
    """
    This rule checks for CVE-2024-31472 vulnerability in Aruba InstantOS and ArubaOS devices.
    The vulnerability allows unauthenticated remote code execution through command injection
    in the Soft AP Daemon service via PAPI UDP port (8211).
    """
    ...
    assert not papi_enabled, (
        f"Device {device.name} is vulnerable to CVE-2024-31472. "
