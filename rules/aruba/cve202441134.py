...
def rule_cve202441134(configuration, commands, device, devices):
    """
    This rule checks for CVE-2024-41134 vulnerability in Aruba EdgeConnect SD-WAN devices.
    ...
    assert not cli_enabled, (
        f"Device {device.name} is vulnerable to CVE-2024-41134. "
