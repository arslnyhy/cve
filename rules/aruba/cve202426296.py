...
def rule_cve202426296(configuration, commands, device, devices):
    """
    This rule checks for CVE-2024-26296 vulnerability in Aruba ClearPass Policy Manager.
    ...
    assert not web_enabled, (
        f"Device {device.name} is vulnerable to CVE-2024-26296. "
